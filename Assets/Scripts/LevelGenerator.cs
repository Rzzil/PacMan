            ...
            for (int j = 0; j < levelMap.GetLength(1); j++)
            {
                switch (levelMap[i, j])
                {
                    ...
                    case 4:
                        ...
                        if ((i + 1 < levelMap.GetLength(0) && (levelMap[i + 1, j] == 3 || levelMap[i + 1, j] == 4 || levelMap[i + 1, j] == 7)) && (i - 1 >= 0 && (levelMap[i - 1, j] == 3 || levelMap[i - 1, j] == 4 || levelMap[i - 1, j] == 7)))
                        {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        if (i + 1 < levelMap.GetLength(0) && levelMap[i + 1, j] == 4)
                        {
                            Instantiate(assetsList[6], new Vector2(0.55f * j, -0.55f * i), Quaternion.identity);
                        }
                        else if (i - 1 >= 0 && levelMap[i - 1, j] == 4)
                        {
                            Instantiate(assetsList[6], new Vector2(0.55f * j, -0.55f * i), Quaternion.Euler(0, 0, 180));
                        }
                        break;
                }
            }
